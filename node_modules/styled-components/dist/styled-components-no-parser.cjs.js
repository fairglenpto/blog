...
var flatten$2 = function flatten(chunks, executionContext) {
...
var flatten = function flatten(chunks, executionContext) {
  ...
  if (!isRuleSet(chunks)) {
    return flatten$2(chunks, executionContext);
  }
  ...
  return chunks.reduce(function (ruleSet, chunk) {
    ...
    var newChunk = chunk.reduce(function (rules, rule) {
      ...
      if (Array.isArray(rule)) {
        return [].concat(rules, flatten$2(rule, executionContext));
      }
      ...
      if ((typeof rule === 'undefined' ? 'undefined' : _typeof(rule)) === 'object' && isPlainObject(rule)) {
        return [].concat(rules, [objToCss(rule)]);
      }
...
// 
var css = (function (interpolations) {
  return flatten(interpolations);
});
...
//# sourceMappingURL=styled-components-no-parser.cjs.js.map
